...
class ImportTestCase(TestCase):
    ...
    def test_get_surveys_mapping_repeated(self):
        ...
        surverys_in_aether = get_aether_surveys()
        self.assertGreater(len(surverys_in_aether), len(surveys))
    ...
    def test_import_one_document(self):
        ...
        data = get_aether_responses(self.survey_id)
    ...
    def test_dont_reimport_document(self):
        ...
        docs = get_aether_responses(self.survey_id)
    ...
    def test_update_document(self):
        ...
        updated = get_aether_responses(self.survey_id)[0]

...
def get_aether_responses(mapping_id):
    url = kernel_utils.get_mapping_responses_url(mapping_id)
    return kernel_utils.get_all_docs(url)
...
class ImportTestCase(TestCase):
    ...
    def test_import_one_document(self):
        ...
        data = get_aether_responses(self.mapping_id)
    ...
    def test_dont_reimport_document(self):
        ...
        docs = get_aether_responses(self.mapping_id)
    ...
    def test_update_document(self):
        ...
        updated = get_aether_responses(self.mapping_id)[0]

...
from couchdb_tools import api as couchdb
...
class ImportTestCase(TestCase):
    ...
    @mock.patch('importer.import_couchdb.core_utils.test_connection', return_value=False)
    ...
    @mock.patch('importer.import_couchdb.import_synced_docs',
    ...
    @mock.patch('importer.import_couchdb.post_to_gather',
                side_effect=Exception('mocked exception'))

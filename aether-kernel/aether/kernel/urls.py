...
urlpatterns = generate_urlpatterns(token=True) + [
    ...
    url(f'{API_PREFIX}/schema/', AetherSchemaView.without_ui(cache_timeout=0), name='api_schema'),
    url(f'{API_PREFIX}/swagger/$', AetherSchemaView.with_ui('swagger', cache_timeout=0), name='schema-swagger-ui'),
]

...
class MappingSetMappingViewSet(CustomViewSet):
    queryset = models.MappingSetMapping.objects.all()
    serializer_class = serializers.MappingSetMappingSerializer
    filter_class = filters.MappingSetMappingFilter

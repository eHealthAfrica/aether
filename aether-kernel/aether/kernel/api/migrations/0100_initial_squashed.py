    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('revision', models.TextField(default='1', verbose_name='revision')),
                ('name', models.CharField(max_length=50, unique=True, verbose_name='name')),
                ('schema', django.contrib.postgres.fields.jsonb.JSONField(blank=True, null=True, validators=[aether.python.validators.validate_avro_schema], verbose_name='AVRO schema')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('definition', django.contrib.postgres.fields.jsonb.JSONField(validators=[aether.python.validators.validate_schema_definition], verbose_name='AVRO schema')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('revision', models.TextField(default='1', verbose_name='revision')),
                ('name', models.CharField(max_length=50, unique=True, verbose_name='name')),
                ('definition', django.contrib.postgres.fields.jsonb.JSONField(validators=[aether.python.validators.validate_mapping_definition], verbose_name='mapping rules')),

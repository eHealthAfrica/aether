...
prepare_and_test_container odk-importer aether/core/api/tests/fixtures/project_empty_schema.json
...
prepare_and_test_container couchdb-sync aether/core/api/tests/fixtures/project.json

...
# TODO: question -- how access new resources reliably while the old ones are being deleted?
# -- three cases:
# 1. delete everything and start a new cluster in namespace test
# 2. run tests (on code change)
# 3. update config (on config change)

...
class UtilsTests(TestCase):
    ...
    def test__get_mapping_url_testing(self):
        ...
        self.assertEqual(
            ...
            'http://core-test/mappings/1/submissions/'
        )
        self.assertEqual(
            utils.get_mapping_submissions_url(1, 2),
            'http://core-test/mappings/1/submissions/2/'
        )
        self.assertRaises(
            Exception,
    ...
    def test__get_mapping_url__no_testing(self):
        ...
        self.assertEqual(
            utils.get_mapping_submissions_url(1),
            'http://core/mappings/1/submissions/'
        )
        self.assertEqual(
            utils.get_mapping_submissions_url(1, 2),
            'http://core/mappings/1/submissions/2/'
        )
        self.assertRaises(
            Exception,
            utils.get_mapping_submissions_url,
    ...
    @mock.patch.dict('os.environ', GATHER_ENV_MOCK)
    def test_submit_to_core__without_submission(self):
        self.assertRaises(
            Exception,
            utils.submit_to_core,
            submission=None,
    ...
    @mock.patch.dict('os.environ', GATHER_ENV_MOCK)
    def test_submit_to_core__without_submission_id(self, mock_post, mock_put):
        utils.submit_to_core(submission={'_id': 'a'}, mapping_id=1, submission_id=None)
    ...
    @mock.patch('requests.post')
    @mock.patch.dict('os.environ', GATHER_ENV_MOCK)
    def test_submit_to_core__with_submission_id(self, mock_post, mock_put):
        utils.submit_to_core(submission={'_id': 'a'}, mapping_id=1, submission_id=1)

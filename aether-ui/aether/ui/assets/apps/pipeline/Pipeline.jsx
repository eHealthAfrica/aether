    ...
    return (
      <Modal header={header} buttons={buttons}>
        ...
        <div className='check-default ml-4'>
          <input type='checkbox' id='check1' checked={this.state.deleteOptions.entityTpes}
            onChange={(e) => {
              this.setState({
        ...
        <div className='check-default ml-4'>
          <input type='checkbox' id='check2' checked={this.state.deleteOptions.schemaDecorations}
            onChange={(e) => {
              this.setState({

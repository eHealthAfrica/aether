...
`curl http://admin:adminadmin@aether.local/dev/kernel/mappings/`
  ...
  "results":[
    {
      ...
      "url":"http://aether.local/dev/kernel/mappings/2e4d2216-aade-48ef-8bc3-12f4792df07a/",
      "project_url":"http://aether.local/dev/kernel/projects/774e33c8-d82b-43f9-82e4-27bb513aff68/",
      "submissions_url":"http://aether.local/dev/kernel/submissions/?mapping=2e4d2216-aade-48ef-8bc3-12f4792df07a",
...
```bash
curl http://admin:adminadmin@aether.local/dev/kernel/entities/
```
...
The [next step](walkthrough-connect) is to extend the data pipeline so that it flows all the way out to CKAN.
